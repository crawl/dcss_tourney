...
INDIVIDUAL_CATEGORIES = (
    ...
    Category(
        ...
        "score",
        None,
        [ColumnDisplaySpec("score", "Progress / 90", True, True, None),
...
BANNERS = [
    ...
    Banner(
        ...
        'Yredelemnul demands that you kill as many uniques as possible and will recognise success by awarding <code>THE HARVEST</code>. There are 87 uniques in DCSS.',
        "yredelemnul",
        "#994d00",
    ),
    Banner(
