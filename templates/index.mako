...
can be added to your ${version} rcfile on <b>any</b> of the public servers. If
you add clan membership lines to more than one rcfile, then the rcfile on the
server earliest in the list CAO, CBRO, CDO, CKO, CPO, CUE, CWZ, CXC, LLD will take
precedence.
            </p>
          </div>
