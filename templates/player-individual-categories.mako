...
<div class="row">
  <div class="col">
    <div class="jumbotron category category-image text-light p-3" style="background-image: linear-gradient(to right, rgba(0,0,0,0.4) 31%, rgba(0,0,0,1) 33%), url('/images/individual/${htmlgen.slugify(category.name)}.png');">
