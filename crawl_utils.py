...
if "WEB_BASE" in os.environ:
    ...
    WEB_BASE = 'https://crawl.develz.org/tournament/0.34'
...
# doesn't exist.
SCORE_FILE_DIR = 'html.tourney0.34'
...
CDO_MORGUE_BASE = 'https://crawl.develz.org/morgues/0.34'
...
LLD_MORGUE_BASE = 'http://lazy-life.ddo.jp:8080/morgue-0.34'
