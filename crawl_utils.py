...
if "WEB_BASE" in os.environ:
    ...
    WEB_BASE = 'https://crawl.develz.org/tournament/0.30'
...
# doesn't exist.
SCORE_FILE_DIR = 'html.tourney0.30'
...
CDO_MORGUE_BASE = 'http://crawl.develz.org/morgues/0.30'
...
CWZ_MORGUE_BASE = 'https://webzook.net/soup/morgue/0.30'
CXC_MORGUE_BASE = 'http://crawl.xtahua.com/crawl/morgue'
LLD_MORGUE_BASE = 'http://lazy-life.ddo.jp:8080/morgue-0.30'
...
def morgue_link(xdict):
  ...
  if src.find('cao') >= 0:
    ...
    base = CBR2_MORGUE_BASE
  elif src.find('cdi') >= 0:
    base = CDI_MORGUE_BASE
  elif src.find('cdo') >= 0:
