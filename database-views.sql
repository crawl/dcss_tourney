...
SELECT z.player, IF(28 * z.completed + z.deepest <= 756, 28 * z.completed + z.deepest, 756) AS floors, z.completed, z.deepest
  FROM ziggurats AS z;

CREATE OR REPLACE VIEW clan_ziggurats AS
SELECT p.team_captain, z.player, IF(28 * z.completed + z.deepest <= 756, 28 * z.completed + z.deepest, 756) AS floors,
